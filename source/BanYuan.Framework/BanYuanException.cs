...
namespace BanYuan.Framework
{
    public class BanYuanException : Exception
    {
        ...
        public BanYuanException(string message, Exception innerException) : base(message, innerException) { }
        /// <summary>
        /// Initializes a new instance of the <c>ApworksException</c> class with the specified
        ...
        public BanYuanException(string format, params object[] args) : base(string.Format(format, args)) { }
        #endregion
    }
}
